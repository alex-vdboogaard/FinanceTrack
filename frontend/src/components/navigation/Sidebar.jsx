            ...
            <nav className="nav">
                <ul>
                    <li className={isActive('/overview') ? 'active' : ''}>
                        <Link to="/overview">
                            <img className='icon' src='../src/assets/home.svg' alt="home-icon" />
                            {!isCollapsed && <span>Home</span>}
                        </Link>
                    </li>
                    <li className={isActive('/budget') ? 'active' : ''}>
                        <Link to="/budget">
                            <img className='icon' src='../src/assets/budget.svg' alt="budget-icon" />
                            {!isCollapsed && <span>Budget</span>}
                        </Link>
                    </li>
                    <li className={isActive('/bank-accounts') ? 'active' : ''}>
                        <Link to="/bank-accounts">
                            <img className='icon' src='../src/assets/cards.svg' alt="accounts-icon" />
                            {!isCollapsed && <span>Accounts</span>}
                        </Link>
                    </li>
                    <li className={isActive('/investments') ? 'active' : ''}>
                        <Link to="/investments">
                            <img className='icon' src='../src/assets/investments.svg' alt="investments-icon" />
                            {!isCollapsed && <span>Investments</span>}
                        </Link>
                    </li>
                    <li className={isActive('/savings') ? 'active' : ''}>
                        <Link to="/savings">
                            <img className='icon' src='../src/assets/savings.svg' alt="savings-icon" />
                            {!isCollapsed && <span>Savings</span>}
                        </Link>
                    </li>
                    <li className={isActive('/assets') ? 'active' : ''}>
                        <Link to="/assets">
                            <img className='icon' src='../src/assets/assets.svg' alt="assets-icon" />
                            {!isCollapsed && <span>Assets</span>}
                        </Link>
                    </li>
                    <li className={isActive('/statements') ? 'active' : ''}>
                        <Link to="/statements">
                            <img className='icon' src='../src/assets/statements.svg' alt="statements-icon" />
                            {!isCollapsed && <span>Statements</span>}
                        </Link>
                    </li>
                </ul>
                <button className="toggle-btn" onClick={toggleSidebar}>
                    {isCollapsed ? <img src='../src/assets/arrow-right.svg' alt="expand-icon" /> : <img src='../src/assets/arrow-left.svg' alt="collapse-icon" />}
                </button>
            </nav>
        </div>
    );
