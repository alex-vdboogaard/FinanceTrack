      ...
      <nav className="nav">
        <ul>
          <li className={isActive("/overview") ? "active" : ""}>
            <Link to="/overview">
              <img
                className={isActive("/overview") ? "active-icon" : "icon"}
                src={homeIcon}
                alt="home-icon"
              />
          ...
          <li className={isActive("/budget") ? "active" : ""}>
            <Link to="/budget">
              <img
                className={isActive("/budget") ? "active-icon" : "icon"}
                src={budgetIcon}
                alt="budget-icon"
              />
            ...
            <ul id="toggled-items">
              <li className={isActive("/bank-accounts") ? "active" : ""}>
                <Link to="/bank-accounts">
                  <img
                    className={
                      isActive("/bank-accounts") ? "active-icon" : "icon"
                    }
                    src={accountsIcon}
                    alt="accounts-icon"
                  />
              ...
              <li className={isActive("/investments") ? "active" : ""}>
                <Link to="/investments">
                  <img
                    className={
                      isActive("/investments") ? "active-icon" : "icon"
                    }
                    src={investmentsIcon}
              ...
              <li className={isActive("/savings") ? "active" : ""}>
                <Link to="/savings">
                  <img
                    className={isActive("/savings") ? "active-icon" : "icon"}
                    src={savingsIcon}
                    alt="savings-icon"
                  />
              ...
              <li className={isActive("/assets") ? "active" : ""}>
                <Link to="/assets">
                  <img
                    className={isActive("/assets") ? "active-icon" : "icon"}
                    src={assetsIcon}
                    alt="assets-icon"
                  />
              ...
              <li className={isActive("/loans") ? "active" : ""}>
                <Link to="/loans">
                  <img
                    className={isActive("/loans") ? "active-icon" : "icon"}
                    src={loansIcon}
                    alt="loans-icon"
                  />
          ...
          <li className={isActive("/statements") ? "active" : ""}>
            <Link to="/statements">
              <img
                className={isActive("/statements") ? "active-icon" : "icon"}
                src={statementsIcon}
                alt="statements-icon"
              />
