...
export default function UploadStatement({ folderId = null }) {
  ...
  return (
    <>
      <Button className="primary-btn" onClick={() => setModalOpen(!modalOpen)}>
        + Upload
      </Button>
      <Modal isOpen={modalOpen} toggleSidebar={toggleModal} type={"center"}>
        ...
        >
          ...
          />
          <Button className="secondary-btn" type="button" onClick={toggleModal}>
            Cancel
          </Button>
