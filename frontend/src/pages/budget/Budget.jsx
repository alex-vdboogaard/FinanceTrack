...
export default function Budget() {
    ...
    useEffect(() => {
        fetchData("http://localhost:3001/budget/review")
            .then((data) => {
    ...
    return (
        <main>
            <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <Button onClick={newReview} className="primary-btn">+ Monthly review</Button>
            </div>
            <Expenses setExpenses={setExpenses}></Expenses>
            <Income setIncome={setIncome} />
            <BudgetGraphs expenses={expenses} income={income} reviews={reviews}></BudgetGraphs>
